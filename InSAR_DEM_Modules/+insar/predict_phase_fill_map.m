...
[Xmat, ~] = make_feature_matrix_from_keepmask(feat, model.featureKeepMask, model.opts);
...
% -------------------------------------------------------------------------
function [Xmat, names] = make_feature_matrix_from_keepmask(feat, keepMask, modelOpts)
...
keep = ismember(allNames, modelOpts.selectedFeatures);
