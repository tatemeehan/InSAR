...
if ~isfield(unwrapOpts.phaseFill,'useCommittee') || isempty(unwrapOpts.phaseFill.useCommittee)
    unwrapOpts.phaseFill.useCommittee = true;
end
if ~isfield(unwrapOpts.phaseFill,'nCommittee') || isempty(unwrapOpts.phaseFill.nCommittee)
    unwrapOpts.phaseFill.nCommittee = 5;
end
if ~isfield(unwrapOpts.phaseFill,'treesPerModel') || isempty(unwrapOpts.phaseFill.treesPerModel)
    unwrapOpts.phaseFill.treesPerModel = 75;
end
if ~isfield(unwrapOpts.phaseFill,'subsampleFrac') || isempty(unwrapOpts.phaseFill.subsampleFrac)
    unwrapOpts.phaseFill.subsampleFrac = 0.7;
end
if ~isfield(unwrapOpts.phaseFill,'baseSeed') || isempty(unwrapOpts.phaseFill.baseSeed)
    unwrapOpts.phaseFill.baseSeed = 11;
end
if ~isfield(unwrapOpts.phaseFill,'committeeAggregate') || isempty(unwrapOpts.phaseFill.committeeAggregate)
    unwrapOpts.phaseFill.committeeAggregate = 'median';   % 'median' or 'mean'
end
if ~isfield(unwrapOpts.phaseFill,'storeCommitteeSpread') || isempty(unwrapOpts.phaseFill.storeCommitteeSpread)
    unwrapOpts.phaseFill.storeCommitteeSpread = true;
end
