...
% coreNames = {'X','Y','Z','slope','aspect_sin','aspect_cos','cor','rnorm','cnorm','distToTrusted'};
coreNames = {'X','Y','Z','slope','aspect_sin','aspect_cos', ...
             'cor','rnorm','cnorm','distToTrusted','distToCRSupport'};
